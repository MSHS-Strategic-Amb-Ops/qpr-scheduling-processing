...
qpr_scheduling_query <- glue("CREATE TABLE PROD_QPR_SCHEDULING AS
                             ...
                             FROM
                             (SELECT e.*, f.DEPT_MANAGED_PROV_MAP, f.SITE_PROV_MAP, f.OFFICE_PROCEDURE_PROV_MAP, f.CLINICAL_DEPT_PROV_MAP_ORG,
                             f.CLINICAL_SUB_DEPT_PROV_MAP_ORG
                             FROM
                             ...
                             FROM
                             (SELECT APPT_DTTM, APPT_MADE_DTTM, CONTACT_DATE, SITE, DEPARTMENT_ID, DEPARTMENT_NAME, DEPT_SPECIALTY_NAME,
